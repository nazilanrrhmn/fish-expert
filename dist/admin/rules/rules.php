...
<head>
  ...
  <title>Admin - Daftar Rules Penyakit</title>
          ...
          <div class="table-responsive">
            ...
            <div class="konten">
              <form id="form1" name="form1" method="post" action="./simpanrules.php" enctype="multipart/form-data" onsubmit="return validateForm()">
                <h5 class="text-center">Tambah Rule Penyakit Ikan Mas</h5>
                      ...
                      <strong>&nbsp;&nbsp;Pilih Penyakit
                        <select name="daftarpenyakit" id="daftarpenyakit">
                          ...
                          while ($datap = mysqli_fetch_array($qryp)) {
                            ...
                            echo "<option value='$datap[id]' $cek>$datap[kdpenyakit]&nbsp;|&nbsp;$datap[nama_penyakit]</option>";
                          }
                          ?>
