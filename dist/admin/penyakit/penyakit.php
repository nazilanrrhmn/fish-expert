...
<head>
  ...
  <title>Admin - Daftar Penyakit</title>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><img src="../../img/thumb/<?php echo $data['gambar']; ?>" alt="Gambar Penyakit" width="100%" height="100%"></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="./simpanpenyakit.php" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" rows="3" id="pencegahan" name="pencegahan"></textarea>
            </div>
            <div class="form-group">
